defmodule Rougarou.Context.Seasons do
  @moduledoc """
  A data context for managing seasons.
  """
  import Ecto.Query
  import Rougarou.Context.Clamp, only: [clamp: 1, non_negative: 1]

  alias Rougarou.Repo
  alias Rougarou.Schema.Season

  require Logger

  # Read default page size from compile-time config
  @default_page_size Application.compile_env(:rougarou, :min_page_size)
